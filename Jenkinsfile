pipeline {
    ...
    stages {
        ...
        stage('Deploy MySQL Deployment and Service') {
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'devopsshack-cluster', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://A6C8A1AF1C9DA97D2FE6E8F145DE1B0D.sk1.ap-south-1.eks.amazonaws.com') {
